...
(function() {
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      if (!((this.record.constructor.ajax != null) && (this.model.ajax != null))) {
        return Error('Both related models must extend Spine.Ajax');
      }
      if ((_ref = options.url) == null) {
        options.url = "" + (Spine.Ajax.getURL(this.record)) + (Spine.Ajax.getURL(this.model));
      }
      return this.model.fetch(params, options);
    };
