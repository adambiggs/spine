...
(function() {
  ...
  Spine.Route = (function(_super) {
    ...
    Route.navigate = function() {
      ...
      if (options.trigger) {
        this.matchRoutes(this.path, options);
      }
      if (options.shim) {
        return;
      }
    ...
    Route.matchRoutes = function(path, options) {
      var matches, route, _i, _len, _ref1;
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        route = _ref1[_i];
        if (route.match(path, $.extend({}, options))) {
          matches.push(route);
        }
      }
    ...
    function Route(path, callback) {
      ...
      if (typeof path === 'string') {
        ...
        replaceParams = function() {
          var match, offset, string, substrs, _i;

          match = arguments[0], substrs = 4 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 2) : (_i = 1, []), offset = arguments[_i++], string = arguments[_i++];
          if (substrs[1]) {
            return "(?!" + substrs[1] + "\\b)([^\/]*)";
          } else {
            return '([^\/]*)';
